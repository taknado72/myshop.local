...
<head>
    ...
    <link rel="stylesheet" href="css/wizard.css?9c6acce">
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/flags.css?9c6acce">
    <script type="text/javascript" src="../js/jquery-1.8.3.min.js?9c6acce"></script>
    <script type="text/javascript" src="js/tips.js?9c6acce"></script>
    <script type="text/javascript" src="js/setup.js?9c6acce"></script>
</head>
<body>
    <div id="wizard">
        <div id="header">
